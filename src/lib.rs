...
const NP_TYPE_INFO: NPType = 0x00;
const NP_TYPE_REPLY: NPType = 0x01;
const NP_TYPE_UNSET: NPType = 0xff;

const NP_INFO_TEXT: NPOption = 0x00;

const NP_REPLY_VALID: NPOption = 0x00;
const NP_REPLY_BAD_TYPE: NPOption = 0x01;
const NP_REPLY_BAD_OPTION: NPOption = 0x02;
const NP_REPLY_BAD_SIZE: NPOption = 0x03;
const NP_REPLY_INVALID_DATA: NPOption = 0x04;
const NP_REPLY_UNSET: NPOption = 0xff;

const NP_UNSET_UNSET: NPOption = 0xff;

const NP_MIN_PKT_SIZE: usize = 4;
const NP_MAX_PKT_SIZE: usize = 4096;
